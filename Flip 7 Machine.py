...
while True:
    ...
    if choice == "Flip":
        ...
        if CheckBust() :
            ...
            roundNum += 1
            Bank(15) #15 is the bonus for 7 number cards
            ResetHand()
            cumulativeProb = 1.0
    ...
    #Debug Game Options
        ...
        CheckHand()
    elif choice == "CheckHandScore" :
        print(CheckHandScore())    